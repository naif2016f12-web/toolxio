        ...
        <div className="max-w-4xl mx-auto">
            <header className="mb-8">
                <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-3xl font-bold">Smart Video Tools</h2>
                </div>
                <p className="text-muted-foreground text-lg">
                    Process your videos entirely in the browser. Fast, private, and free.
                </p>
            </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="glass-card p-6 rounded-2xl flex flex-col gap-4">
                    ...
                    <p className="text-muted-foreground text-sm">
                        Convert MP4 to WebM, GIF, or extract audio as MP3.
                    </p>
                ...
                <div className="glass-card p-6 rounded-2xl flex flex-col gap-4">
                    ...
                    <h3 className="text-xl font-semibold">Video Trimmer</h3>
                    <p className="text-muted-foreground text-sm">
                        Cut and trim your videos without uploading to any server.
                    </p>
                    <button className="mt-4 px-4 py-2 bg-muted hover:bg-muted/80 rounded-xl text-sm font-medium transition-all">
                        Open Trimmer
                    </button>
            ...
            <div className="glass-card p-12 rounded-3xl border-dashed border-2 border-border flex flex-col items-center justify-center text-center gap-6">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">Select a file to start processing locally.</p>
                </div>
